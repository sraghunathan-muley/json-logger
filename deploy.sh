...
# This script requires the following 1 arguments in the following order:
...
echo mvn -f json-logger/pom.xml clean install
mvn -f json-logger/pom.xml clean install 
