	...
	@Override
	  public void propertyField( JFieldVar field, JDefinedClass clazz, String propertyName, JsonNode propertyNode ) {
		...
		if (sdkMap != null) {
            ...
            if (sdkMap.get("parameterDsl") != null) {
                Map<String, Object> parameterDslMap = (Map<String, Object>) sdkMap.get("parameterDsl");
                if (parameterDslMap.get("allowReferences") != null && parameterDslMap.get("allowInlineDefinition") != null) {
                    Boolean allowReferences = Boolean.valueOf(String.valueOf(parameterDslMap.get("allowReferences")));
                    System.out.println(">> Found parameterDsl.allowReferences: " + allowReferences);
                    Boolean allowInlineDefinition = Boolean.valueOf(String.valueOf(parameterDslMap.get("allowInlineDefinition")));
                    System.out.println(">> Found parameterDsl.allowInlineDefinition: " + allowInlineDefinition);
                    field.annotate(ParameterDsl.class)
                            .param("allowReferences", allowReferences)
                            .param("allowInlineDefinition", allowInlineDefinition);
                } else if (parameterDslMap.get("allowReferences") != null) {
                    Boolean allowReferences = Boolean.valueOf(String.valueOf(parameterDslMap.get("allowReferences")));
                    System.out.println(">> Found parameterDsl.allowReferences: " + allowReferences);
                    field.annotate(ParameterDsl.class).param("allowReferences", allowReferences);
                } else if (parameterDslMap.get("allowInlineDefinition") != null) {
                    Boolean allowInlineDefinition = Boolean.valueOf(String.valueOf(parameterDslMap.get("allowInlineDefinition")));
                    System.out.println(">> Found parameterDsl.allowInlineDefinition: " + allowInlineDefinition);
                    field.annotate(ParameterDsl.class).param("allowInlineDefinition", allowInlineDefinition);
                }
            }
